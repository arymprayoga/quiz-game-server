...
<div class="card mt-2">
    <div class="card-header">
        ...
        <a data-toggle="modal" data-target="#modaltambahbuku"><button type="button" class="btn btn-info btn-sm" style="float: right;"><i class="fa fa-plus"></i> Tambah
                Buku</button></a>
        {{-- @endcan --}}
    </div>
    <div class="card-body">
...
{{-- Modal Hapus Buku --}}
<div class="modal fade" id="modalhapusbuku" tabindex="-1" role="dialog" aria-labelledby="modalhapusbukuLabel" aria-hidden="true">
...
{{-- Modal Tambah Buku --}}
<div class="modal fade" id="modaltambahbuku" role="dialog" aria-labelledby="modaltambahbukuLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('add-master-buku') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-body">
